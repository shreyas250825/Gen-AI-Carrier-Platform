...
const Report = () => {
  ...
  const computeReportData = () => {
    ...
    const questionData = answers.map((answer: any, index: number) => {
      ...
      const question = questions.find((q: any) => q.id === answer.question_id) || questions[index] || {};
      ...
      return {
        id: question.id || answer.question_id || `q${index + 1}`,
        question: question.text || question.question || answer.question || 'Question',
